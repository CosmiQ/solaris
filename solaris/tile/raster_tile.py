...
#        self.cog_output = cog_output
    ...
    def get_tile_bounds(self):
        ...
        self.tile_bounds = split_geom(geometry=self.aoi_boundary, src_tile_size=self.tile_size, transform=self.src.transform, use_metric_size=self.use_src_metric_size)
