...
html_theme_options = {
    ...
    "bootstrap_version": "3",
    "navbar_links": [("Tutorials", "tutorials/index"), ("API", "api/index")],
}
...
man_pages = [(main_doc, "solaris", "solaris Documentation", [author], 1)]
...
texinfo_documents = [
    (main_doc, "solaris", "solaris Documentation", author, "solaris"),
]
